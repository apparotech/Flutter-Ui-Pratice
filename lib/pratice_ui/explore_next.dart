...
class ExploreNext extends StatefulWidget {
  const ExploreNext({super.key});

  @override
  State<ExploreNext> createState() => _ExploreNextState();
}

class _ExploreNextState extends State<ExploreNext> {
  @override
